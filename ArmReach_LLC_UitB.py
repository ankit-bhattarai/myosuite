...
from myosuite.envs.myo.myouser.pointing import AdaptiveTargetWrapper
...
# from myosuite.envs.myo.myouser.pointing import LLCEEPosAdaptiveEnvMJXV0
...
def main(args: DictConfig):
  print(OmegaConf.to_yaml(OmegaConf.to_container(args, resolve=True)))
  # print(os.getcwd())

    # experiment_id, project_id='mjx-training', n_train_steps=100_000_000, n_eval_eps=1,
  ...
  # env = envs.get_environment(args.env.env_name, model_path=args.env.model_path, auto_reset=False, **args.env)
  breakpoint()
  env = hydra.utils.instantiate(args.env)
  # env = envs.get_environment(args.env.env_name, args.env)
  return env
