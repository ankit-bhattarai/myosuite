...
def main():
  ...
  env_name = 'myoArm_llc_eepos_adaptive_mjx-v0'
  ...
  envs.register_environment(env_name, LLCEEPosAdaptiveDirectCtrlEnvMJXV0)
  ...
  env = envs.get_environment(env_name, model_path=path, **kwargs)
